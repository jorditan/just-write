      ...
      <section className="flex items-center justify-center h-[90vh] w-full">
        <article className="w-2/4 flex flex-col gap-6 justify-center items-center ">
          ...
          <div className="flex flex-row gap-2 items-center">
            ...
            <CustomModal buttonText="¿Qué es la mecanografía?" buttonType="outline" modalTitle="¿Qué es la mecanografía?" modalContent="La mecanografía es la habilidad de escribir en un teclado de manera rápida y precisa sin mirar las teclas." video="/sci-fi-typing.gif" videoAlt="Sci-Fi Typing Animation" />
          </div>
        </article>
      </section>
    </>
